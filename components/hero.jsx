//client component "use client"  / dynamic pages
"use client";
...
//when component is unmounted(cleanup) => remove EventListener
  ...
  return (
    <div className='pb-20 px-4'>
        <div className='container mx-auto text-center'>
            ...
            <div className='flex justify-center space-x-5 space-y-5'>
                <Link href="/dashboard">
